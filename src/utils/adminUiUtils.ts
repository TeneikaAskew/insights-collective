...
// ABOUTME: two-letter initials, a deterministic avatar colour, and the role→
// ABOUTME: badge-variant mapping. Kept separate so every admin page can reuse them.

// Palette mirrors the Soft Studio prototype avatar colours.
const AVATAR_COLORS = [
...
/** Stable avatar colour derived from a seed (e.g. the user id). */
...
/** Maps a role to the colour-coded badge variant (see ui/badge.tsx). */
