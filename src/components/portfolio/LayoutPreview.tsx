...
export function LayoutPreview({ layout, isSelected, onSelect }: LayoutPreviewProps) {
  const renderPreview = () => {
    const commonElements = {
      profile: (
        <div className="bg-gray-100 rounded p-1.5 text-xs">
          <div className="w-6 h-6 bg-gray-300 rounded-full mb-1 mx-auto"></div>
    ...
    switch (layout) {
          ...
          <div className="flex gap-1 h-20">
            <div className="w-1/3 space-y-1">
              ...
              <div className="flex gap-1">
                <div className="w-1.5 h-1.5 bg-[#9b87f5] rounded-full"></div>
      ...
      case 'hero-timeline':
        return (
          <div className="space-y-1 h-20">
            <div className="bg-gradient-to-r from-[#9b87f5] to-purple-600 rounded p-1.5 text-center">
            ...
            <div className="space-y-1">
              {Array(2).fill(0).map((_, i) => (
                <div key={i} className="flex gap-1">
                  <div className="w-1.5 h-1.5 bg-[#9b87f5] rounded-full mt-1"></div>
      ...
      case 'hero-focus':
        return (
          <div className="space-y-1 h-20">
            <div className="bg-gradient-to-r from-[#9b87f5] to-purple-600 rounded p-1.5 h-3/5 flex items-center justify-center">
              <div className="text-center">
                <div className="w-6 h-6 bg-white rounded-full mx-auto mb-1"></div>
                <div className="h-0.5 bg-white rounded w-8 mx-auto"></div>
              </div>
            </div>
      ...
      default:
        return <div className="h-20 bg-gray-100 rounded flex items-center justify-center text-xs">Preview</div>;
    }
  };
