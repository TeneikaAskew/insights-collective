...
import { useAuthenticatedNavigation } from '@/hooks/useAuthenticatedNavigation'; // New import
import { Clock } from 'lucide-react';

export default function PageVisibilityGuard({ children }) {
  const location = useLocation();
  const { isAuthenticated } = useAuthenticatedNavigation(); // Changed from useAuth
