...
const LessonManager = ({ moduleId }: LessonManagerProps) => {
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Organize content into structured lessons</p>
        </div>
            ...
            <div className="flex items-center justify-center h-96 border-2 border-dashed border-border rounded-lg bg-muted/20">
              <div className="text-center">
                ...
                <p className="text-muted-foreground mb-6 max-w-md">
                  Select a lesson from the sidebar to start creating content blocks, or create your first lesson to get started.
                </p>
