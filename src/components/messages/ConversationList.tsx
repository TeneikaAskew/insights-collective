...
const ConversationList: React.FC<ConversationListProps> = ({ conversations = [], loading, error }) => {
  ...
  const sortedConversations = [...conversations].sort((a, b) => {
    ...
    const aUnread = a.last_message && !a.last_message.read;
    const bUnread = b.last_message && !b.last_message.read;
    ...
    <div className="space-y-2 h-full overflow-auto">
      {sortedConversations.map((conversation) => {
        ...
        const isUnread = conversation.last_message && 
                         ...
                         conversation.last_message.sender_id !== conversation.created_by;
