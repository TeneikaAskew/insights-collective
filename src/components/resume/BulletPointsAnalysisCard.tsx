...
const BulletPointsAnalysisCard: React.FC<BulletPointsAnalysisCardProps> = ({
  ...
  const handleSave = () => {
    const improvedBullet = {
      ...
      xyz_scores: {
        action: Math.min(10, (selectedBullet?.xyz_scores?.action || 0) + 2),
        metrics: Math.min(30, (selectedBullet?.xyz_scores?.metrics || 0) + 5),
        clarity: Math.min(15, (selectedBullet?.xyz_scores?.clarity || 0) + 3),
        industry: Math.min(25, (selectedBullet?.xyz_scores?.industry || 0) + 5),
        achievement: Math.min(20, (selectedBullet?.xyz_scores?.achievement || 0) + 3)
      },
          ...
          <div className="mt-6 border-t pt-4">
            ...
            <BulletPointChart bullet={{
              ...
              xyz_scores: {
                ...
                metrics: Math.min(30, displayBullet.xyz_scores.metrics + 1),
                clarity: Math.min(15, displayBullet.xyz_scores.clarity + 1),
                industry: Math.min(25, displayBullet.xyz_scores.industry + 1),
