    ...
    >
      <CardHeader className="pb-2">
        <div className="flex justify-between items-start gap-2">
          <CardTitle className="text-lg font-display">{role.title}</CardTitle>
          <Badge className="shrink-0 border-transparent bg-accent text-accent-foreground hover:bg-accent">
            {formattedCategory}
          </Badge>
        </div>
