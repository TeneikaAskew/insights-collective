...
function PortfolioExplorer() {
  ...
  usePageOnboarding({ 
    tourId: 'portfolio-explorer', 
    autoStart: true,
    dependencies: ['career-agent'] // Start after career agent tour
  });
    ...
    <AppLayout>
      <div className="container mx-auto p-4">
        <PageHeader
          ...
          description="Create, plan, and track portfolio projects aligned with your career goals"
          pageTourId="portfolio-explorer"
        />

        <Tabs value={activeTab} onValueChange={handleTabChange} className="space-y-6" data-tour="portfolio-intro">
          <div className="w-full">
            <TabsList className="grid grid-cols-2 sm:grid-cols-4 gap-1 sm:gap-2 mb-8 w-full max-w-4xl mx-auto h-auto p-2">
              ...
              <TabsTrigger value="tracker" className="relative flex-col sm:flex-row gap-1 sm:gap-2 py-2 sm:py-1.5" data-tour="project-tracker">
                <div className="bg-[#9b87f5] rounded-full w-5 h-5 sm:w-6 sm:h-6 text-white flex items-center justify-center text-xs flex-shrink-0">
                  3
                </div>
