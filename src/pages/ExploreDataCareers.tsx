        ...
        <Tabs defaultValue="grid" className="space-y-4">
          <div className="flex justify-between items-center">
            <TabsList className="bg-aquaTeal/10">
              <TabsTrigger value="grid" className="data-[state=active]:bg-amber-500 data-[state=active]:text-white">Grid View</TabsTrigger>
          ...
          <TabsContent value="grid" className="space-y-6">
            {filteredRoles.length > 0 ? <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <TabsContent value="categories" className="space-y-10">
            {Object.entries(rolesByCategory).map(([category, roles]) => <div key={category} className="space-y-4">
                <div>
