...
// Industry-specific keywords for resume analysis
export const industryWords = [
  ...
  /* Finance & accounting */
  "payroll", "liabilities", "calculation", "federal", "state", "income", "tax", "taxes", "security", "payments", "compensation",
  "attendance", "tracking", "overtime", "PTO", "HR", "guidelines", "policies", "procedures"
];
...
// Combined keywords for skills detection
