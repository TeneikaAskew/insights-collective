...
-- Create policies
CREATE POLICY IF NOT EXISTS "Admins can manage page visibility" 
ON public.page_visibility 
FOR ALL 
USING (has_admin_access(auth.uid()));

CREATE POLICY IF NOT EXISTS "Everyone can view page visibility" 
ON public.page_visibility 
FOR SELECT 
USING (true);
...
CREATE TRIGGER IF NOT EXISTS update_page_visibility_updated_at
